...
function Tooltip({ ...props }: TooltipPrimitive.Root.Props) {
  // disableHoverablePopup: this is a tooltip, not a hover-card. By default Base UI keeps
  // the popup open when the cursor moves toward it (e.g. upward), which is the annoying
  // "it stays when I go up" behavior. Disable that so it closes when the trigger is left.
